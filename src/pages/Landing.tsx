...
const Landing = () => {
  ...
  return <div className="min-h-screen bg-slate-900 text-white" onMouseMove={handleMouseMove}>
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 w-full z-50 py-3 sm:py-4 transition-all duration-500 backdrop-blur-md ${isNavScrolled ? 'bg-slate-900/90 shadow-lg' : ''}`}>
        <div className="container mx-auto px-4 sm:px-8 flex items-center justify-between">
          <div className="flex items-center">
            <img src="/lovable-uploads/1ea529ec-4385-4e6a-b22b-75cc2778cfcd.png" alt="Dorry Logo" className="w-8 h-8 sm:w-10 sm:h-10" />
          </div>
          ...
          <div className="hidden md:flex space-x-4">
            <a href="/login" className="px-4 sm:px-6 py-2 border-2 border-cyan-400 text-cyan-400 rounded-lg hover:bg-cyan-400/10 transition-colors text-sm sm:text-base">
              Se connecter
            </a>
            <a href="/signup" className="px-4 sm:px-6 py-2 bg-gradient-to-r from-cyan-400 to-blue-500 text-slate-900 rounded-lg hover:shadow-lg transition-all text-sm sm:text-base">
              S'inscrire
            </a>
          </div>
        </div>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden pt-16 sm:pt-0">
        ...
        <div className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center opacity-70 hover:opacity-100 transition-opacity">
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-slate-800 relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
            <div className="flex-1 relative order-2 lg:order-1">
              <div className="relative w-full aspect-video">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-400/5 to-blue-500/5 rounded-xl lg:rounded-2xl animate-pulse"></div>
              </div>
            </div>
            ...
            }].map((step, index) => <div key={index} className="p-4 sm:p-6 bg-slate-900/50 rounded-xl border-l-4 border-cyan-400 hover:transform hover:translate-x-2 transition-all">
                  <div className="text-cyan-400 text-base sm:text-lg font-bold mb-2">{step.number}</div>
      ...
      {/* Features Section */}
      <section className="py-16 sm:py-24 lg:py-32 bg-slate-900">
        <div className="container mx-auto px-4 sm:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[{
            icon: <Mic className="w-10 h-10 sm:w-12 sm:h-12" />,
          ...
          }].map((feature, index) => <div key={index} className="p-6 sm:p-8 bg-slate-800/30 rounded-xl text-center hover:transform hover:scale-105 transition-all group">
      ...
      {/* Why Dorry Section */}
      <section className="py-16 sm:py-24 lg:py-32 bg-slate-800">
        <div className="container mx-auto px-4 sm:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
          ...
          }].map((benefit, index) => <div key={index} className="p-4 sm:p-6 bg-slate-900/50 rounded-xl hover:transform hover:scale-105 transition-all">
                <div className="text-cyan-400 mb-3 sm:mb-4">{benefit.icon}</div>
                <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-cyan-400">{benefit.title}</h3>
                <p className="text-slate-300 text-sm sm:text-base">{benefit.description}</p>
              </div>)}
          </div>
          
          {/* Stats */}
          <div className="flex flex-col sm:flex-row justify-around items-center gap-8 sm:gap-16">
            {[{
            end: 87,
            suffix: "%",
            ...
            label: "pour un compte rendu complet"
                ...
                <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-cyan-400 mb-2">
                  <AnimatedCounter end={stat.end} suffix={stat.suffix} />
                </div>
                <p className="text-base sm:text-lg lg:text-xl text-slate-300 max-w-48">{stat.label}</p>
              </div>)}
          </div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-24 lg:py-32 bg-gradient-to-br from-cyan-400/10 to-blue-500/10 relative overflow-hidden">
        <FloatingParticles />
        <div className="container mx-auto px-4 sm:px-8 text-center relative z-10">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 max-w-4xl mx-auto">
          ...
          <ConfettiButton 
            href="/support"
            className="bg-gradient-to-r from-cyan-400 to-blue-500 text-slate-900 px-8 sm:px-12 py-4 sm:py-6 rounded-xl text-lg sm:text-xl font-bold hover:shadow-2xl transform hover:scale-105 transition-all"
          >
            Demander l'accès
          </ConfettiButton>
        </div>
      ...
      <footer className="bg-slate-900 py-12 sm:py-16">
        <div className="container mx-auto px-4 sm:px-8">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 mb-12 sm:mb-16">
            <div className="flex-1 min-w-64 text-center lg:text-left">
              <img src="/lovable-uploads/1ea529ec-4385-4e6a-b22b-75cc2778cfcd.png" alt="Dorry Logo" className="w-8 h-8 sm:w-10 sm:h-10 mb-4 mx-auto lg:mx-0" />
              <p className="text-slate-300 max-w-sm mx-auto lg:mx-0">
                L'assistante IA qui révolutionne l'accompagnement de projet
              </p>
            </div>
            
            <div className="flex-2 grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-16">
              <div className="text-center lg:text-left">
                <h4 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-cyan-400">Légal</h4>
                <div className="space-y-2 sm:space-y-3">
                  <a href="/privacy-policy" className="block text-slate-300 hover:text-cyan-400 transition-colors text-sm sm:text-base">Politique de confidentialité</a>
                  <a href="/terms-of-service" className="block text-slate-300 hover:text-cyan-400 transition-colors text-sm sm:text-base">Conditions d'utilisation</a>
                  <a href="/legal-notice" className="block text-slate-300 hover:text-cyan-400 transition-colors text-sm sm:text-base">Mentions légales</a>
                </div>
              </div>
              <div className="text-center lg:text-left">
                <h4 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-cyan-400">Support</h4>
                <div className="space-y-2 sm:space-y-3">
                  <a href="/support" className="block text-slate-300 hover:text-cyan-400 transition-colors text-sm sm:text-base">Aide & Contact</a>
                  <a href="#" className="block text-slate-300 hover:text-cyan-400 transition-colors text-sm sm:text-base">FAQ</a>
                  <a href="#" className="block text-slate-300 hover:text-cyan-400 transition-colors text-sm sm:text-base">Tutoriels</a>
                </div>
              </div>
              <div className="text-center lg:text-left">
                <h4 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-cyan-400">Innovation</h4>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center pt-6 sm:pt-8 border-t border-slate-700 gap-4">
            <p className="text-slate-400 text-xs sm:text-sm text-center sm:text-left">© 2025 Dorry. Tous droits réservés.</p>
            <div className="flex space-x-3 sm:space-x-4">
              <a href="#" className="w-8 h-8 sm:w-9 sm:h-9 bg-slate-800 rounded-full flex items-center justify-center text-slate-400 hover:bg-cyan-400 hover:text-slate-900 transition-all text-sm">L</a>
              <a href="#" className="w-8 h-8 sm:w-9 sm:h-9 bg-slate-800 rounded-full flex items-center justify-center text-slate-400 hover:bg-cyan-400 hover:text-slate-900 transition-all text-sm">T</a>
              <a href="#" className="w-8 h-8 sm:w-9 sm:h-9 bg-slate-800 rounded-full flex items-center justify-center text-slate-400 hover:bg-cyan-400 hover:text-slate-900 transition-all text-sm">I</a>
            </div>
          </div>
        </div>
      </footer>
