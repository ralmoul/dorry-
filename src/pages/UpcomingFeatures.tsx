  ...
  const features = [
    {
      ...
      details: [
        ...
        "La clarté du projet", 
        "Le niveau d'urgence perçue"
      ],
      additionalInfo: "Un indicateur QPV (quartier prioritaire) sera aussi généré automatiquement.",
      benefits: [
        "Permet de prioriser les dossiers avec précision",
        "Identifie les projets à fort potentiel dès le vocal",
        "Optimise la gestion du portefeuille local",
        "Favorise l'égalité des chances avec le repérage QPV"
      ]
    },
    {
      icon: Building2,
      ...
      details: [
        ...
        "Le motif de l'orientation",
        "Les coordonnées complètes"
      ],
      additionalInfo: "Et un bouton \"Contacter la structure\" sera présent dans les mails.",
      benefits: [
        "Gagne du temps pour l'accompagnant",
        "Propose une orientation fluide et personnalisée",
        "Active un réseau local autour du porteur",
        "Encourage à l'action via le bouton de contact"
      ]
    },
    {
      icon: MessageCircle,
      ...
      details: [
        ...
        "Confirmation des RDV planifiés",
        "Rappels d'orientations importantes"
      ],
      ...
      benefits: [
        "Renforce le lien humain, même en automatique",
        "Confirme rapidement les informations clés",
        "Améliore la réactivité du porteur",
        "Crée une expérience proactive et bienveillante"
      ]
    }
  ];
      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div className="text-center mb-8">
          <div className="relative w-16 h-16 mx-auto mb-4">
            ...
            <div className="absolute inset-2 w-12 h-12 rounded-full bg-gradient-to-r from-bright-turquoise/40 to-electric-blue/40 animate-pulse-ai" style={{ animationDelay: '0.5s' }}></div>
        ...
        <div className="space-y-6">
          {features.map((feature, index) => (
            <Card 
              key={index} 
              className="bg-card/50 backdrop-blur-sm border-bright-turquoise/20 hover:border-bright-turquoise/40 transition-all duration-300 hover:shadow-lg hover:shadow-bright-turquoise/10 animate-fade-in"
