  ...
  return <div className="min-h-screen gradient-bg text-foreground">
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div className="flex items-center mb-6">
          <Button variant="ghost" onClick={handleBackToHome} className="p-2 mr-3 hover:bg-white/10 text-white hover:text-white/80">
        ...
        <div className="space-y-6">
          {features.map((feature, index) => <Card key={index} className="bg-card/50 backdrop-blur-sm border-bright-turquoise/20 hover:border-bright-turquoise/40 transition-all duration-300 hover:shadow-lg hover:shadow-bright-turquoise/10 animate-fade-in" style={{
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1">
                    {feature.details.map((detail, detailIndex) => <li key={detailIndex} className="text-sm text-white flex items-start">
                ...
                {/* Additional Info */}
                {feature.additionalInfo && <div className="p-3 rounded-lg bg-gradient-to-r from-bright-turquoise/5 to-electric-blue/5 border border-bright-turquoise/10">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid gap-2">
                    {feature.benefits.map((benefit, benefitIndex) => <div key={benefitIndex} className="flex items-start space-x-2">
