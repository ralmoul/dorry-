              ...
              <div className="prose prose-gray max-w-none">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                  ...
                  <div className="bg-white rounded-xl p-6 border border-gray-300 shadow-md">
                    ...
                    <Button 
                      className="bg-gradient-to-r from-cyan-400 to-blue-500 text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transition-all transform hover:scale-105"
                    >
                      Prendre rendez-vous
                    </Button>
                  </div>
