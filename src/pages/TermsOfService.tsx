      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 space-y-6">
          <section>
            ...
            <p className="text-gray-600">En utilisant Dorry, vous acceptez ces conditions d'utilisation. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser notre service.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">2. Description du service</h2>
            <p className="text-gray-600 mb-4">Dorry est une assistante IA qui :</p>
          ...
          <section>
            ...
            <p className="text-gray-600">Dorry est fourni "en l'état". Nous nous efforçons de maintenir la qualité du service mais ne garantissons pas une disponibilité 100% ou une précision absolue des analyses.</p>
          </section>
