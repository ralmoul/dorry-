            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-4">
              <div className="space-y-1.5 sm:space-y-2">
                ...
                <Input 
                  ...
                  required 
                  className="bg-background/50 border-bright-turquoise/30 focus:border-bright-turquoise h-9 sm:h-11 text-sm" 
                />
              </div>
              <div className="space-y-1.5 sm:space-y-2">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              ...
              <div className="relative">
                <Input 
                  ...
                  required 
                  minLength={6}
                  className="bg-background/50 border-bright-turquoise/30 focus:border-bright-turquoise pr-10 h-9 sm:h-11 text-sm" 
                />
                <button 
                  type="button" 
